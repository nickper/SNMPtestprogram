...
public:
    ...
    virtual void sendMessage(int, std::string str);
    virtual void sendMessage(int32_t, std::string str);
...
private:
    ...
    void constructMessage(int i, std::string str);
    void constructMessage(int32_t i, std::string str);
