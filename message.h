...
enum enumvalue {INTEGER=0x02, BITSTRING=0x03, OCTETSTRING=0x04, EMPTY=0x05, OBJECT_IDENTIFIER=0x06, SEQUENCE=0x30, IPADDRESS=0x40, COUNTER32=0x41, GAUGE32=0x42, TIMETICKS=0x43, OPAQUE=0x44, NASPADDRESS=0x45, COUNTER64=0x46, UINTEGER32=0x47};
